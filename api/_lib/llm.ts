...
import { SYSTEM_PROMPT, buildUserPrompt } from './mother';
...
export async function generateMotherReflection(params: ReflectionParams): Promise<string> {
...
export async function generateDaughterReflection(params: ReflectionParams): Promise<string> {
  return generateReflection(
